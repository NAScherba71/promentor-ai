        ...
        <div className="mx-auto max-w-7xl">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              ...
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Live coding challenge</h2>
              <p className="mt-4 text-lg leading-8 text-gray-600">
                Type in the editor, hit Run, and see how the platform gives instant feedback. The system attempts to run your code on the backend,
                falling back to a simulation if the connection cannot be established.
              </p>
